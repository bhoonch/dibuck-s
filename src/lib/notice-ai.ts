...
const DRAFT_SCHEMA = {
  ...
  properties: {
    title: { type: "string", description: "게시물 제목 (예: '단수 안내')" },
    intro: {
      type: "string",
      description:
...
- 개요 표(items)의 값은 **입력값 그대로** 싣는다. "9월 중" 같은 대략 표기도 다듬지 않는다.
...
출력: {"title":"단수 안내","intro":"입주민 여러분 안녕하십니까. 저수조 정기 청소로 인하여 아래와 같이 수돗물 공급이 일시 중단됨을 안내드립니다.","items":[{"label":"단수 일시","value":"2026년 8월 10일(월) 10:00 ~ 16:00"},{"label":"단수 구역","value":"전 세대"},{"label":"사유","value":"저수조(물탱크) 정기 청소 (수도법에 따른 반기 1회 의무 청소)"}],"bodyLines":["단수 시간 전에 필요한 물을 미리 받아 두시기 바랍니다.","급수 재개 직후에는 일시적으로 녹물이 나올 수 있으니 2~3분간 흘려보낸 후 사용하시기 바랍니다."],"closing":"입주민 여러분의 양해와 협조를 부탁드립니다.","needsClarification":[]}
