...
- 관련근거는 법령 조항(예: 공동주택관리법 제63조(관리주체의 업무))과 당 단지 관리규약 조항을 병기한다. 조문 번호가 확실치 않은 관리규약은 "제○○조"로 쓴다.
- 제목은 반드시 "~의 건"으로 끝낸다.
...
관련근거: 가. 공동주택관리법 제63조(관리주체의 업무) / 나. 당 단지 관리규약 제○○조(관리비의 집행)
추진목적
...
관련근거: 가. 공동주택관리법 시행령 제19조 및 단지 관리규약 제○○조 / 나. 주택관리업자 및 사업자 선정지침 (국토교통부 고시)
품의목적
