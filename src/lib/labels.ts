...
export const roleGuide: Record<(typeof assignableRoles)[number], string> = {
  DIRECTOR:
    "단지 정보·직원·구독·결제·결재선을 바꿉니다. 남이 쓴 문서도 고치고 폐기할 수 있으며, 서비스 탈퇴는 마스터만 할 수 있습니다.",
  ACCOUNTANT:
    "문서를 만들고, 남이 쓴 문서도 결재에 올릴 수 있습니다 — 다만 고치거나 폐기하는 것은 작성자와 마스터만 합니다. 세대 명부(엑셀)도 올립니다 — 부과·수납 실무자 자리입니다. 단지 정보·직원·구독·결제 설정은 볼 수만 있습니다.",
  STAFF:
    "문서를 열람하고 작성합니다. 자기가 쓴 문서만 결재에 올리고 고칠 수 있으며, 설정은 볼 수만 있습니다.",
};
