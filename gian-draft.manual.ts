...
const CASES = [
  ...
  {
    // 일정 미입력 — "○월 ○일" 빈칸 대신 "결재 후 계약 체결 시 확정"으로 적는지 본다
    label: "품의서 · 일정 미입력 (CCTV 교체 300만원)",
    form: {
      work: "단지 출입구 CCTV 노후 카메라 교체",
      location: "정문·후문 출입구 4개소",
      why: "야간 화질이 떨어져 차량 식별이 어렵습니다",
      schedule: "",
      quotes: [
        { vendor: "C 시큐리티(주)", amount: 3_000_000 },
        { vendor: "D 안전기술(주)", amount: 3_300_000 },
      ],
    },
    amount: 3_000_000,
    vat: true,
